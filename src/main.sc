...
theme: /BankTheme
    ...
    state: Start
        q!: $regex</start>
        a: Добрый день, Вы позвонили в call-center Dushanbe City, чем могу Вам помочь? || tts = "Добрый день,# Вы позвонили в колл-центр Dushanbe City,# чем могу Вам помочь?"
        buttons:
